...
Ohjelmaa käytetään application-kansiossa komennolla `./gradlew run --args "<regex> <tarkastettava merkkijono>"`
...
[Viikko 6](https://github.com/Ajhaa/Regex/blob/master/dokumentaatio/viikkoraportit/viikko6.md)  
